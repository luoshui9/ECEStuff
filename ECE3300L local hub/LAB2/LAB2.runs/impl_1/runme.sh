...
HD_PWD='E:/Projects/SchoolGit/ECEStuff/ECE3300L local hub/LAB2/LAB2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_calc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_calc.tcl -notrace
