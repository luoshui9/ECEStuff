...
HD_PWD='E:/Projects/SchoolGit/ECEStuff/ECE3300L local hub/LAB2/LAB2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_calc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_calc.tcl
