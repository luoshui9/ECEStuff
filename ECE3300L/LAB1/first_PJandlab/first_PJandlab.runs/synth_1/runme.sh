...
HD_PWD='E:/Projects/SchoolGit/ECEStuff/ECE3300L/LAB1/first_PJandlab/first_PJandlab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_2x1_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_2x1_3bit.tcl
